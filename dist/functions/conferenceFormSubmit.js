...
exports.conferenceFormSubmit = void 0;
const sendMail_1 = require("../common/sendMail");
const util_1 = require("../common/util");
function conferenceFormSubmit(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const sendMailToMarketing = yield (0, sendMail_1.conferenceFormSendMailToMarketing)(req);
            const sendMailToUser = yield (0, sendMail_1.conferenceFormSendMailToUser)(req);
...
exports.conferenceFormSubmit = conferenceFormSubmit;
//# sourceMappingURL=conferenceFormSubmit.js.map