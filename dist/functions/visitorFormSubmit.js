...
exports.visitorFormSubmit = void 0;
const sendMail_1 = require("../common/sendMail");
const util_1 = require("../common/util");
function visitorFormSubmit(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const sendMailToMarketing = yield (0, sendMail_1.visitorFormSendMailToMarketing)(req);
            const sendMailToUser = yield (0, sendMail_1.visitorFormSendMailToUser)(req);
...
exports.visitorFormSubmit = visitorFormSubmit;
//# sourceMappingURL=visitorFormSubmit.js.map